        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4 class="text-center font-weight-bold mb-2">Selamat datang di E-Absen</h4>
              <h4 class="text-center font-weight-bold mb-4">SMPN .. Semarang</h4>
              {{-- Alert Reset Success --}}
              ...
              @endif
              <form class="" method="POST" action="/postSAlogin">
                @csrf
