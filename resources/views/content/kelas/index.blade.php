      ...
      <div class="card p-4">
        <div class="card-body">
          <div class="d-flex justify-content-between mb-3">
            <a href="/ruang/create" class="btn btn-primary btn-sm mb-3 font-weight-bold my-auto"><i class="ti-plus mr-2"></i>Tambah Ruang Kelas</a>
            <form action="/searchRuang" method="get">
              <input type="text" name="search" class="form-control" placeholder="Search Ruang..." aria-label="Search...">
            </form>
          </div>
            ...
            <table class="table table-hover table-striped">
              <thead>
                <tr>
                  ...
                  <th scope="col">Jumlah Maksimal Siswa</th>
              ...
              <tbody>
                @foreach ($ruang as $item)
                  <tr>
                    ...
                    <td>
                      <a href="/ruang/{{ $item->id }}" class="btn btn-info btn-sm"><i class="ti-eye"></i></a>
                      <a href="/ruang/{{ $item->id }}/edit" class="btn btn-warning btn-sm"><i class="ti-pencil-alt"></i></a>
