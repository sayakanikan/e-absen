    ...
    <div class="col-md-12 grid-margin">
      <div class="row">
        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
          <h3 class="font-weight-bold">Akun Siswa</h3>
        </div>
      ...
      <div class="card p-4">
        <div class="card-body">
          <div class="d-flex justify-content-between mb-3">
            <a href="/siswa/create" class="btn btn-primary btn-sm mb-3 font-weight-bold my-auto"><i class="ti-plus mr-2"></i>Tambah Siswa</a>
            <form action="/searchRuang" method="get">
              <input type="text" name="search" class="form-control" placeholder="Search siswa..." aria-label="Search...">
            </form>
          </div>
              ...
              <tbody>
                @foreach ($siswa as $item)
                  <tr>
                    ...
                    <td>{{ $item->gender }}</td>
                    <td>
                      <a href="/siswa/{{ $item->id }}" class="btn btn-info btn-sm"><i class="ti-eye"></i></a>
                      <a href="/siswa/{{ $item->id }}/edit" class="btn btn-warning btn-sm"><i class="ti-pencil-alt"></i></a>
